...
interface IndexedA extends A {
    0: TryA<this, S<this> extends (infer Elem)[] ? [number, Elem][] : ArrayExpected<S<this>>>;
}
interface IndexedT extends T {
    0: TryT<this, B<this> extends [number, infer Elem][] ? Elem[] : ArrayOfIndexValuePairsExpected<B<this>>>;
}
