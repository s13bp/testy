...
export declare const createStore: (initialValues?: Iterable<readonly [AnyAtom, unknown]> | undefined) => {
    ...
    w: <Value_1, Update, Result extends void | Promise<void>>(writingAtom: WritableAtom<Value_1, Update, Result>, update: Update, version?: VersionObject | undefined) => Result;
...
export declare const createStoreForExport: (initialValues?: Iterable<readonly [AnyAtom, unknown]> | undefined) => {
