...
declare function getAugmentedHooks<T extends Connector>(connector: T, { useAccounts }: ReturnType<typeof getStateHooks>, { useAccount, useIsActive }: ReturnType<typeof getDerivedHooks>): {
